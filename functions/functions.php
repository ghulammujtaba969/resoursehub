...
function get_admstatus($id)
{
	...
	$listadmstatus = array(
		...
		'1' => '<span class="badge badge-success" id="bns-status-badge">Active</span>',

		'2' => '<span class="badge badge-danger" id="bns-status-badge">Inactive</span>'
	);
...
$logintypes = array(
	...
	array('id' => 1, 'name' => 'faculty'),

	array('id' => 2, 'name' => 'Students')
...
function generateNewString($len = 128)
{
